...
var MiniAdpter=(function(){
	...
	MiniAdpter.init=function(isPosMsg,isSon){
		...
		if(MiniAdpter.window.navigator.userAgent.indexOf('MiniGame')<0 &&MiniAdpter.window.navigator.userAgent.indexOf('QQ/')<0)return;
...
var MiniFileMgr=(function(){
	...
	MiniFileMgr.downFiles=function(fileUrl,encoding,callBack,readyUrl,isSaveFile,fileType){
		...
		(isSaveFile===void 0)&& (isSaveFile=false);
		(fileType===void 0)&& (fileType="");
		var downloadTask=MiniFileMgr.wxdown({url:MainVersion.conversionUrl(fileUrl),success:function (data){
	...
	MiniFileMgr.downOtherFiles=function(fileUrl,callBack,readyUrl,isSaveFile){
		(readyUrl===void 0)&& (readyUrl="");
		(isSaveFile===void 0)&& (isSaveFile=false);
		MiniFileMgr.wxdown({url:MainVersion.conversionUrl(fileUrl),success:function (data){
				if (data.statusCode===200){
	...
	MiniFileMgr.onSaveFile=function(readyUrl,md5Name,isAdd,encoding,callBack,fileSize){
		...
		if(isAdd){
			...
			MiniFileMgr.filesListObj[fileurlkey]={md5:md5Name,readyUrl:readyUrl,size:fileSize,time:Browser.now(),v:MainVersion.getFullVNum(readyUrl),encoding:encoding};
